...
public class JiraReporter {
    ...
    @SneakyThrows
    public void printRestReport(List<LogWorkEntry> entries, String dateFromIn) {
        var dateFrom = StringUtils.isNotBlank(dateFromIn) ? dateFromIn : JiraConfig.START_DATE_TIME;
        printCsvReport(entries, dateFrom);
